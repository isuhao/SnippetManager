...
Represents the set of [Literal](../Literal/README.md#_top)s\.
...
* System\.Collections\.Generic\.[ICollection](https://docs.microsoft.com/en-us/dotnet/api/system.collections.generic.icollection-1)\<[Literal](../Literal/README.md#_top)>
* System\.Collections\.Generic\.[IEnumerable](https://docs.microsoft.com/en-us/dotnet/api/system.collections.generic.ienumerable-1)\<[Literal](../Literal/README.md#_top)>
* System\.Collections\.Generic\.[IList](https://docs.microsoft.com/en-us/dotnet/api/system.collections.generic.ilist-1)\<[Literal](../Literal/README.md#_top)>

## Constructors

| Constructor | Summary |
| ----------- | ------- |
| [LiteralCollection()](-ctor/README.md#_top) | Initializes a new instance of the [LiteralCollection](#_top) class that is empty\. |
...
| [Item\[String\]](Item/README.md#_top) | Returns first literal with the specified identifier |
...
| [Contains(String)](Contains/README.md#_top) | Determines whether a [Literal](../Literal/README.md#_top) with a specified identifier is in the [LiteralCollection](#_top)\. |
...
| [Find(String)](Find/README.md#_top) | Returns first literal with the specified identifier |
...
| [Remove(String)](Remove/README.md#_top) | Removes the first occurrence of a literal with a specific identifier |
...
| [Sort()](Sort/README.md#Pihrtsoft_Snippets_LiteralCollection_Sort) | Sorts the elements in the entire [LiteralCollection](#_top) using the [LiteralComparer.Identifier](../Comparers/LiteralComparer/Identifier/README.md#_top) comparer\. |
| [Sort(IComparer\<Literal>)](Sort/README.md#Pihrtsoft_Snippets_LiteralCollection_Sort_System_Collections_Generic_IComparer_Pihrtsoft_Snippets_Literal__) | Sorts the elements in the entire [LiteralCollection](#_top) using the specified comparer\. |
