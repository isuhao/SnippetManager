...
[Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) &#x2192; [ValidationRule](../ValidationRule/README.md) &#x2192; SnippetTypeValidationRule

## Constructors

| Constructor | Summary |
| ----------- | ------- |
| [SnippetTypeValidationRule()](-ctor/README.md) | |
