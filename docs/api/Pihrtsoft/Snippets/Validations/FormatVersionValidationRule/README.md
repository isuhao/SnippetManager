...
[Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) &#x2192; [ValidationRule](../ValidationRule/README.md) &#x2192; FormatVersionValidationRule

## Constructors

| Constructor | Summary |
| ----------- | ------- |
| [FormatVersionValidationRule()](-ctor/README.md) | |
